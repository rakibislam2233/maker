...
const HeroSection = () => {
  ...
  return (
    <section className="w-full h-full px-5 py-8 md:py-28 xl:py-36">
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        <div>
          <h1 className="text-3xl md:text-5xl xl:text-7xl xxl:text-[80px]  font-bold leading-normal pb-1">
            Find Your
          </h1>
          <h1 className="text-3xl md:text-5xl xl:text-[80px]  font-bold leading-normal">
            Perfect <span className="text-secondary">Match</span>
          </h1>
